...
import { PhoneFilled, DeleteFilled, PaperClipOutlined, LoadingOutlined } from "@ant-design/icons";
...
const ChatHeader = (props) => {
 ...
 const privateKey="3c5a5583-bb2f-4aba-b734-7775f715c5ae"; const projectId ="2a0d24d8-85c2-441c-b62d-3677624c18f4"
  ...
  const onFilesSelect = (e) => {
    ...
    Array.from(e.target.files ?? []).forEach((file) => formData.append("attachments", file, file.name));
    ...
    <div className="ce-custom-chat-header">
        ...
        <div>
          ...
          <div className="ce-custom-header-icon-wrapper">
            ...
            {isDeleteLoading ? (
              ...
              <DeleteFilled onClick={onDelete} className="ce-custom-header-icon" />
            )}
          </div>
        </div>
      )}
      ...
      <style>{`
        .ce-custom-header-avatar {
          ...
          box-shadow: ${otherMember?.is_online ? "rgb(24 144 255 / 35%)" : "rgb(245 34 45 / 35%)"} 0px 2px 7px;
